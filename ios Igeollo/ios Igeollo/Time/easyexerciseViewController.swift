...
class easyexerciseViewController: UIViewController {
    ...
    var timer: Timer?
    var totalTime: Int = 900
    var remainingTime: Int = 900
    ...
    @IBAction func youtubeLink(_ sender: UIButton) {
        if let url = URL(string: "https://youtu.be/swRNeYw1JkY?si=sHBbm0HtocrShRNl") {
